        ...
        <div className="w-full">
            ...
            >
                <div className="relative text-default">
                    <img src={contact} alt="college image" className="w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[570px]" />
                    ...
                    <div className="absolute top-3 right-6 text-right text-white">
                        <div className="flex flex-col items-end">
                            <h1 className="text-xl sm:text-xl md:text-2xl lg:text-3xl py-4 font-main-head font-bold">CONTACT US</h1>
